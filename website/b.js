...
function license() {
  ...
  if (typeof $license_key === 'undefined') {
    _0x59a12f('Dilarang menghapus variable <b>$license_key</b>..')
  } else {
    if (typeof $license_item === 'undefined') {
      _0x59a12f('Dilarang menghapus variable <b>$license_item</b>..')
    } else {
      if (
        ...
        if (_0x3711dc === null) {
          ...
          _0x3711dc.innerHTML =
            '&#0169;' +
            _0xd5bdf5 +
            ' &#8212; Made with. <a href="https://hamuweb.com' +
            $license_item +
          ...
          if (_0x4352db == '' || _0x4352db == undefined) {
            ...
            if (location.hostname.indexOf(_0x4352db) == -1) {
              ...
              if (_0x25bef4 != $license_item) {
                ...
                console.log(
                  'Developed by. https://hamuweb.com ( Premium Version )'
                )
              }
            }
          }
