const $license_item = 'toko-wa-plus-blogger-template'
license()
function license() {
  ...
  function _0x59a12f(_0x1ce0db) {
    var _0x4c1945 =
      ...
      _0x1ce0db +
      '</p>                    <br>                    <hr style="border:0;border-top:1px solid #ddd;">                    <br>                    <a href="https://hamuweb.com/' +
      $license_item +
  ...
  if (typeof $license_key === 'undefined') {
    _0x59a12f('Please dont remove license key <b>$license_key</b>..')
  } else {
    if (typeof $license_item === 'undefined') {
      _0x59a12f('Dont remove license key <b>$license_item</b>..')
    } else {
      if (
        ...
        console.log(
          'Developed by. https://hamuweb.com/ ( Free / Trial Version )'
        )
        var _0x3711dc = document.getElementById('copyright')
        if (_0x3711dc === null) {
          _0x59a12f(
            '<b>Made by Hamuweb</b><br><br><small>Please contact hamuweb to activated your license key</small><br><br><small>#ERR_COPYRIGHT</small>'
          )
        } else {
        ...
        if ($license_key === '') {
          _0x59a12f(
            '<b>Kicense Key</b> needed..<br><br><small>#ERR_LICENSE</small>'
          )
        } else {
          ...
          if (_0x4352db == '' || _0x4352db == undefined) {
            _0x59a12f(
              '<b>Your License Key</b> is not valid.</b><br><br><small>#ERR_KEY</small>'
            )
          } else {
            if (location.hostname.indexOf(_0x4352db) == -1) {
              ...
              if (_0x25bef4 != $license_item) {
                ...
                console.log(
                  'Design by. https://hamuweb.com ( Premium Version )'
                )
              }
            }
          }
