    ...
    init() {
        ...
        if ( jQuery('.anita-lightbox-link').length ) {
            if ( typeof PhotoSwipe !== 'function' ) {
                jQuery.getScript('https://cdn.jsdelivr.net/gh/hamudev/jsdelivr/anita/js/lib/photoswipe.min.js').done(function() {
                    if ( _self.pswp ) {
    ...
    init_page() {
        ...
        if ( jQuery('.anita-owl-container:not(.is-init)').length ) {
            ...
            if ( typeof jQuery.fn.owlCarousel == "undefined" ) {
                jQuery.getScript('https://cdn.jsdelivr.net/gh/hamudev/jsdelivr/anita/js/lib/owl.carousel.min.js').done(function() {
                    anita_init_owl();
                });
            } else {
                anita_init_owl();
        ...
        if ( jQuery('.anita-masonry:not(.brickwall-grid)').length ) {
            ...
            if ( typeof Anita_BrickWall !== 'function' ) {
                jQuery.getScript('https://cdn.jsdelivr.net/gh/hamudev/jsdelivr/anita/js/anita-brickwall.js').done(function() {
        ...
        if ( jQuery('.anita-justified-grid:not(.is-init)').length ) {
            ...
            if ( typeof jQuery.fn.justifiedGallery == "undefined" ) {
                jQuery.getScript('https://cdn.jsdelivr.net/gh/hamudev/jsdelivr/anita/js/lib/jquery.justifiedGallery.min.js').done(function() {
        ...
        if ( jQuery('.anita-gl-carousel-gallery').length ) {
            if ( typeof Anita_GL_Carousel !== 'function' ) {
                jQuery.getScript('https://cdn.jsdelivr.net/gh/hamudev/jsdelivr/anita/js/anita-gl-carousel.js');
            }
        }
        ...
        if ( jQuery('.anita-gl-roll-gallery').length ) {
            if ( typeof Anita_GL_Roll !== 'function' ) {
                jQuery.getScript('https://cdn.jsdelivr.net/gh/hamudev/jsdelivr/anita/js/anita-gl-roll.js');
            }
        }
        ...
        if ( jQuery('.anita-gl-slider-gallery').length ) {
            if ( typeof Anita_GL_Slider !== 'function' ) {
                jQuery.getScript('https://cdn.jsdelivr.net/gh/hamudev/jsdelivr/anita/js/anita-gl-slider.js');
            }
        }
        ...
        if ( jQuery('.anita-flat-carousel:not(.is-init)').length ) {
            ...
            if ( typeof Anita_Carousel !== 'function' ) {
                jQuery.getScript('https://cdn.jsdelivr.net/gh/hamudev/jsdelivr/anita/js/anita-carousel.js').done(function() {
